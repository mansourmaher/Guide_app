...
import OffreTags from "../../add_new_offre/_compoenets/tags";
import { useEffect } from "react";

interface EditOfferSecondaryDetailsProps {
  onSecondaryDetailsChange: (details: any) => void;
  initialValue: {
    price: number;
...
function EditoFerSecondaryDeatils({
  onSecondaryDetailsChange,
  initialValue,
}: EditOfferSecondaryDetailsProps) {
  console.log("secondaryDeatils:", initialValue);
  ...
  useEffect(() => {
    ...
    form.setValue("number_of_places", initialValue.number_of_places);
    form.setValue("category", initialValue.category);
    form.setValue("tags", initialValue.tags);
    form.setValue("startDate", initialValue.startDate);
    form.setValue("endDate", initialValue.endDate);
  }, [initialValue]);
...
export default EditoFerSecondaryDeatils;
